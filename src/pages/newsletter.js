		...
		<Layout>
			<section className='newsletter-page'>
				<div className='page-center'>
					...
					<form className='contact-form' netlify name='contact' method='post' netlify-honeypot='bot-field'>
						<input type='text' name='name' placeholder='Your name' className='form-control' />
						<input type='email' name='email' placeholder='Your emal' className='form-control' />
